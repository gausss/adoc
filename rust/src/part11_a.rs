...
pub fn compute_flashes(input: Vec<&str>) -> i32 {
    ...
    let mut flashes = 0;
    for _ in 0..100 {
        flashes += step(&mut octo_grid);
    }

    flashes
}

fn step(octo_grid: &mut Grid<i32>) -> i32 {
...
mod tests {
    ...
    fn test() {
        ...
        assert_eq!(compute_flashes(input), 1656);
    }
    ...
    fn solve() {
        ...
        println!("Result 11A: {}", compute_flashes(input));
    }
}
